...
const firstNumberDisplay = () => {
    if (result !== null) {
        return <Text style={result  === 99999 ? [Styles.screenFirstNumber, {color: colors.result}] : [Styles.screenFirstNumber, {fontSize: 46, color: colors.result}]}>{result?.toString()}</Text>; 
    }
